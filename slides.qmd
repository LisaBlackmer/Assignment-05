---
title: "GDP per capita correlations"
format:
  revealjs:
    slide-level: 3 # H3 headings become slides
    theme: solarized # Choose a theme
    transition: fade # Choose a transition effect
---
